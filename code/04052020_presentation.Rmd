...
- Quick note: You may notice that the number of cases after exclusion is **higher** than before exclusion. This is because all N's are survey-weighted. Essentially, cases after exclusion probably had lower selection probability and thus get upweighted more heavily than in overall sample
